...
| Add/Remove Programs | Primary icon; Margin name; separate version and publisher fields | Currently registered as “Margin version 0.1.2”; clean name presentation remains proposed |
