...
Read [the canonical design](design/canonical-design.md), [implementation status](design/implementation-status.md), and [verification record](design/verification.md) before interpreting this as a finished release. Known remaining work includes semantic table layout, exact inline source mapping, native accessibility and IME qualification, complete visual/contrast testing, and packaged performance measurements.
